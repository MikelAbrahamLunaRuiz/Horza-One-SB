...
public class EmergenciaController {
    ...
    @GetMapping("/usuarios-dentro/tutor/{idTutor}")
    public ResponseEntity<List<UsuarioEmergenciaDTO>> obtenerUsuariosDentroPorTutor(@PathVariable Integer idTutor) {
        return ResponseEntity.ok(emergenciaService.obtenerUsuariosDentroPorTutor(idTutor));
    }
